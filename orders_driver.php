...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    if($_POST['delivered'])
    {
        ...
        $accepted = "Yes";
        $stat = "1";
        $query = "update truck_orders set delivered ='{$accepted}', statusId='{$stat}' where truckOrderId = '{$trucking_order_id}'";
       // $query = "update truck_orders set statusId ='{$stat}' where truckOrderId = '{$trucking_order_id}'";
